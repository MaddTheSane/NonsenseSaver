...
{
	NSMutableArray *theArray = [[NSMutableArray alloc] initWithCapacity:[toSave count]];
...
{
	NSMutableArray *theArray = [[NSMutableArray alloc] initWithCapacity:[theSaved count]];
	...
	dispatch_once(&onceToken, ^{
		@autoreleasepool {
			NSDictionary *defaultValues = @{ NONSSingularNounList : @[@"ape", @"apple", @"armpit", @"astronomer", @"baboon", @"badge", @"balloon",
											 ...
											 NONSVerbList :
												 [self prepareVerbsForSaving:@[
																			   [NONSVerb verbWithArray:@[@"accepts", @"accept", @"accepted", @"accepted", @"accepting"]],
